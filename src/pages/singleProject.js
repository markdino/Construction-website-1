        ...
        <Row>
          <Col lg="5" className="proj-details">
            ...
            <p className="description text-secondary">
              ...
              delectus recusandae a? Provident rem ab dolorum soluta laudantium
              aliquam neque, esse, rerum ipsa, sit officiis aut cum pariatur
              consequatur accusantium non odit quas error corrupti maiores
              aspernatur ipsam! Numquam deleniti recusandae optio fugiat qui.
            </p>
            <section className="details mt-5 mb-5">
              <List1 svg={<User />} title="Owner" value="Ms. Marissa Pelonia" />
              <hr />
              <List1
                svg={<Pin />}
                title="Location"
